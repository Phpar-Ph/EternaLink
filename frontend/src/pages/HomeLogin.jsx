            ...
            <div className="w-full p-4 m-4">
              {userData?.memorialPosts?.length > 0 ? (
                userData.memorialPosts.map((memorial) => (
                  <div
                    key={memorial._id}
                    className="bg-gentle-stone p-6 rounded-lg shadow-md"
                  >
                    {/* Post heading */}
                    ...
                    {/* COver Photo */}
                    <div className="h-80 w-full  my-4 relative">
                      <img
                      ...
                      <div className="absolute bottom-0 left-0 flex p-4 gap-4 items-center">
                        <img
                          src="https://plus.unsplash.com/premium_photo-1671656349322-41de944d259b?q=80&w=500"
                          alt=""
                          className="rounded-full ring-1 ring-white ring-opacity-5 h-20 w-20 object-contain"
                        />
                        <div>
                    ...
                    {/* React and Comment */}
                    <div className="flex justify-between py-4 px-8 text-gray-500 text-2xl">
