      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="w-full h-[40vh] relative rounded-xl overflow-hidden shadow-xl mb-8">
          ...
          {/* <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent">
            <div className="absolute bottom-8 left-8 text-white">
              ...
              <p className="text-xl">{memorialData.lifeDates}</p>
            </div>
          </div> */}
        </div>
        {/* Info & Action Section */}
        <div className="bg-white py-12 px-6 rounded-xl shadow-md">
          {/* <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-8">
            <div className="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-700">{memorialData.birthDate}</span>
              </div>
              <div className="flex items-center space-x-2">
                <AiOutlineClockCircle className="w-5 h-5 text-memorial-purple" />
                <span className="text-gray-700">{memorialData.passedDate}</span>
              </div>
              <div className="flex items-center space-x-2">
                <AiOutlineComment className="w-5 h-5 text-memorial-purple" />
                <span className="text-gray-700">
                  {memorialData.memories.length} Memories
                </span>
              </div>
            </div>
          ...
          {/* <div className="mt-8">
            ...
            <p className="text-lg leading-relaxed">{memorialData.bio}</p>
          </div> */}
